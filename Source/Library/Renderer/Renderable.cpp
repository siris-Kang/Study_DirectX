...
)
{
	...
	// how to m_aMeshes Initialize
	// m_aMaterials Initialize
...
const Material& Renderable::GetMaterial(_In_ UINT uIndex)
{
...
const Renderable::BasicMeshEntry& Renderable::GetMesh(_In_ UINT uIndex)
{
...
UINT Renderable::GetNumVertices() const
{
	return 0;
}

UINT Renderable::GetNumIndices() const
{
	return 0;
}

INT Renderable::GetNumMeshes()
{
	return m_aMeshes.size();
}

INT Renderable::GetNumMaterials()
{
